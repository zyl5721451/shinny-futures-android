...
public class KLineRender extends AbstractRender {
    ...
    private final CandleLineDrawing candleLineDrawing = new CandleLineDrawing();
...
//        kLineDrawingList.add(candleLineDrawing);
    ...
    public boolean hasDrawing(IDrawing drawing) {
        return kLineDrawingList.contains(drawing);
    }

    public void removeDrawing(IDrawing drawing) {
        kLineDrawingList.remove(drawing);
    }
